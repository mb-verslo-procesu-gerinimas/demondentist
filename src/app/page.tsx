...
/*
 * Original main page (kept for reference).
 * The route `/` now redirects to `/about`, so the previous home page UI
 * is intentionally not rendered.
 *
 * Note: The code below is commented out to avoid unused-import / unused-function
 * lint issues when `/` is redirected.
 */
